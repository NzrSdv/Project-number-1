...
app.post("/createhabit", async (req, res) => {
  ...
  const { habit_id, habit_title, habit_description, habit_frequency, habit_created_at } = req.body;
  try {
    const result = await pool.query(
      ...
      [habit_id, habit_title, habit_description, habit_frequency, habit_created_at]
    );
